...
public class Aeropuerto
{
	...
	public Aeropuerto (String nombre, String codigo, String nombreCiudad, double latitud, double longitud, Set<String> codigoUtilizados)
	{
		this.nombre = nombre;
		this.codigo = codigo;
		...
		this.codigosUtilizados = codigoUtilizados;
	}
